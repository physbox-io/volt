...
//
// It travels in the *fragment*, not the query string — see `urlPayload.ts`,
// which holds the encoding this and the share link both use. Gzipped and
// base64url'd, a 272-aperture board is under 5KB.
// ---------------------------------------------------------------------------

import { toBase64Url, gzip } from './urlPayload';
